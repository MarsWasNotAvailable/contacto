...
<header>
    <nav id="NavigationBar">
        <a id="Home" class="navigational" href="./index.php"><img src="./cache/icon_site_main.jpg" alt="Home" width="48"></a>
        <div id="HamburgerMenu">
            ...
            <ul id="HamLinks" class="Collapsed">
                <?php
                    if ($IsUserLoggedIn)
                    {
                        echo '<li class="navigational"><a href="./add.php">Add</a></li>';

                        echo '<li class="navigational"><a href="./show.php">Show</a></li>';
